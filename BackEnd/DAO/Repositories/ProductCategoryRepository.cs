...
namespace DAO.Repositories
{
    ...
    public partial class ProductCategorytRepository : IProductCategoryRepository
    {
        ...
        public PagedResult<ProductCategory> GetProductCategories(ProductCategoryPagingManageGetRequest request)
        {
            ...
            {
                string msgError = "";
                var dt = _dbHelper.ExecuteSProcedureReturnDataTable(out msgError, "sp_ProductCategory_GetManageProductCategories", "@request", requestJson);
        ...
        //    {
        //        string msgError = "";
        //        var dt = _dbHelper.ExecuteSProcedureReturnDataTable(out msgError, "sp_ProductCategory_GetPublicTopBanner", "@id", id);
        //        if (!string.IsNullOrEmpty(msgError))
        //        {
        //            throw new Exception(msgError);
        //        }
